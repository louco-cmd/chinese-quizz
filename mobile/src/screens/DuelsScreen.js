      ...
      <Popup visible={showInvite} onClose={() => setShowInvite(false)} maxWidth={380}>
        ...
        <View style={{ flexDirection: 'row', gap: 12 }}>
          ...
          <Pressable
            ...
            disabled={!inviteLink}
            style={{ flex: 1, backgroundColor: copied ? COLORS.success : COLORS.jiayou, borderRadius: 12, paddingVertical: 13, alignItems: 'center', flexDirection: 'row', justifyContent: 'center', gap: 6, opacity: inviteLink ? 1 : 0.6 }}
          >
